...
abstract class DataWatcherPacketBuilder<T> {
    ...
    protected       List<SynchedEntityData.DataValue<?>> watchers = new ArrayList<>();
    ...
    DataWatcherPacketBuilder<T> setInvisible() {
        watchers.add(new SynchedEntityData.DataValue<>(DataWatcherKey.ENTITY_STATUS.getIndex(),
    ...
    DataWatcherPacketBuilder<T> setArmorStandMarker() {
        ...
        watchers.add(new SynchedEntityData.DataValue<>(DataWatcherKey.ARMOR_STAND_STATUS.getIndex(),
    ...
    DataWatcherPacketBuilder<T> setCustomName(String customName) {
        watchers.add(new SynchedEntityData.DataValue<>(DataWatcherKey.CUSTOM_NAME.getIndex(),
                DataWatcherKey.CUSTOM_NAME.getSerializer(),
                getCustomNameDataWatcherValue(customName)));
        watchers.add(new SynchedEntityData.DataValue<>(DataWatcherKey.CUSTOM_NAME_VISIBILITY.getIndex(),
    ...
    DataWatcherPacketBuilder<T> setItemStack(ItemStack itemStack) {
        watchers.add(new SynchedEntityData.DataValue<>(DataWatcherKey.ITEM_STACK.getIndex(),
    ...
    DataWatcherPacketBuilder<T> setSlimeSmall() {
        watchers.add(new SynchedEntityData.DataValue<>(DataWatcherKey.SLIME_SIZE.getIndex(),
