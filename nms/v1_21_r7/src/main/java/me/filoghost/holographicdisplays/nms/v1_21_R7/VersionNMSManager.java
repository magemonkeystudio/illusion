 ...
 */
package me.filoghost.holographicdisplays.nms.v1_21_R7;
...
public class VersionNMSManager implements NMSManager {
    ...
    private static final ReflectField<AtomicInteger>  ENTITY_ID_COUNTER_FIELD =
            ReflectField.lookup(AtomicInteger.class, Entity.class, "c");
    private static final ReflectField<NetworkManager> NETWORK_MANAGER_FIELD   =
            ReflectField.lookup(NetworkManager.class, ServerCommonPacketListenerImpl.class, "e");
